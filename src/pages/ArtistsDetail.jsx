      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2">
          ...
          <div className="space-y-2">
            ...
            {artistSongs.map((track, index) => (
              <div
                key={track.id} className=" flex items-center  gap-4  p-3  rounded-xl  hover:bg-white/5   transition-all cursor-pointer "
              >
                {/* Number */}
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white/5 rounded-2xl p-4">
            ...
            <img
              src={artistSongs[0]?.cover} alt={artistSongs[0]?.title}
              className="w-full h-56 rounded-xl object-cover"
            />

            <h4 className="text-white font-semibold mt-4">  {artistSongs[0]?.title} </h4>

            <p className="text-pink-400">     {artistSongs[0]?.genre}   </p>
          </div>
          ...
          <div className="bg-white/5 p-4 rounded-2xl">
            ...
            <h3 className="text-2xl font-bold text-white"> {artist.followers} </h3>
          ...
          <div className="bg-white/5 p-4 rounded-2xl">
            ...
            <h3 className="text-2xl font-bold text-pink-400">  {artist.genre} </h3>
